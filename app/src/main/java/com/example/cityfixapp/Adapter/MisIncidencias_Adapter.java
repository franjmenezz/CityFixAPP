...
public class MisIncidencias_Adapter extends RecyclerView.Adapter<MisIncidencias_Adapter.ViewHolder> {

    private final List<String> listaIncidencias;

    // Constructor corregido
    public MisIncidencias_Adapter(List<String> listaIncidencias) {
